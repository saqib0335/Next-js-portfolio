  ...
  return (
    <div className='mb-8 mt-20'>
        <div className='flex items-center justify-center gap-8'>
            <a href='https://github.com/saqib0335' target='_blank' rel='noopener noreferrer'>
                <FaGithub fontSize={25} className='opacity-50 hover:opacity-80' />
            </a>
            <a href='https://www.linkedin.com/in/saqib-ali-658647198/' target='_blank' rel='noopener noreferrer'>
